#############################################################################
# Makefile for building: litestarcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: mer feb 18 11:23:18 2015
# Project:  litestarcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile litestarcoin-qt.pro
#############################################################################
...
CXXFLAGS      = -fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2 -D_REENTRANT -fdiagnostics-show-option -w $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lminiupnpc /home/fabiano/litestarcoin/src/leveldb/libleveldb.a /home/fabiano/litestarcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/fabiano/litestarcoin/src/leveldb/libleveldb.a /home/fabiano/litestarcoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: litestarcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile litestarcoin-qt.pro
...
/home/fabiano/litestarcoin/src/leveldb/libleveldb.a: FORCE
	cd /home/fabiano/litestarcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/fabiano/litestarcoin/build/build.h: FORCE
	cd /home/fabiano/litestarcoin; /bin/sh share/genbuild.sh /home/fabiano/litestarcoin/build/build.h
