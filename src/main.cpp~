...
const string strMessageMagic = "litestarcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "litestarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "litestarcoin the new crypto star";
        CTransaction txNew;
        txNew.nTime = 1424251988;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1424251988;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1192589;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xacee09f7da71434ddcf4c8ad3ffd29493999b26ee69aa8801a8cdc984fa48fdf"));
        block.print();
